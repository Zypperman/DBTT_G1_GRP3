...
mindmap
  root[Use Cases]
        id1["`**1.Loan Default <br> Risk Prediction (LDRP)**`"]
            ...
            id1[1.Basic LDRP]
            id1[2.Intermediate<br>LDRP]
            id1[3.CNN-Transformer<br>-assisted LDRP]
            id1[4.Quantum circuit<br>-assisted LDRP]

        id2["`**2.Credit-worthiness <br> Score Prediction (CWP)**`"]
            id2["1.Basic CWP "]
            id2["2.Time-series assisted CWP"]

        id3["`**3.Applicant recommendations**`"]        
            id3["1.Top-k Risk Factor Analysis"]
            id3["2.Loan Package Recommendation"]

        id3["`**4.Ease of identification**`"]        
            id3["1.Application Tagging"]
            id3["2.Application Document<br>summarisation"]
